...
**Skill:** `CREATE-AISKILL-1.0.0.aiskill`
...
│   ├── CHANGELOG.md
│   ├── checksums.yaml     ← written by pack.py (Step 5)
│   ├── assets/
...
python3 skill/assets/scripts/pack.py \
  ...
  --dashboard-dir /Volumes/dashboard/ai-skill-packages
```
...
4. Optionally copy the `.aiskill` to the website and dashboard directories
