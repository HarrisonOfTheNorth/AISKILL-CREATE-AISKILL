#!/usr/bin/env python3
"""
scaffold.py — CREATE-AISKILL v1.0.0
...
Next steps:
  ...
  3. python3 -m pytest skill/assets/tests/ -v   (must all pass)
  4. python3 skill/assets/scripts/pack.py \\
       --skill-dir skill/ --dist-dir dist/ \\
       --website-skills-dir /path/to/ai-skills \\
       --dashboard-dir /path/to/dashboard
  5. git push origin main
  6. git tag v{DEFAULT_VERSION} && git push origin v{DEFAULT_VERSION}
  7. gh release create v{DEFAULT_VERSION} dist/{slug}-{DEFAULT_VERSION}.aiskill \\
